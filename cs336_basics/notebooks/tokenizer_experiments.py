...
#%%
# -------- TinyStoriesV2-GPT4 --------
vocab_path = "/Users/ameefaour/Desktop/CS336_LLM_from_scratch/spring2024-assignment1-basics/data/output_vocab_TinyStoriesV2-GPT4_validation.txt"
merges_path = "/Users/ameefaour/Desktop/CS336_LLM_from_scratch/spring2024-assignment1-basics/data/output_merges_TinyStoriesV2-GPT4_validation.txt"
#%%
...
# %%
data_path = "/Users/ameefaour/Desktop/CS336_LLM_from_scratch/spring2024-assignment1-basics/data/TinyStoriesV2-GPT4-valid.txt"
with open(data_path, "r") as file:
    text = file.read()
#%%
tokens_ids = tokenizer.encode(text)
tokens_ids_np = np.array(tokens_ids, dtype=np.uint16)
np.save("/Users/ameefaour/Desktop/CS336_LLM_from_scratch/spring2024-assignment1-basics/data/tokenized_data/encoded_tokens_TinyStoriesV2-GPT4_validation.npy", tokens_ids_np)
# %%
# -------- OpenWebText --------
